  ...
  return (
    <ScrollView style={styles.settingsScrollView}>
      <View style={styles.settingsSection}>
        <View
          style={[styles.aboutContainer, { backgroundColor: theme.background }]}
        >
          <View style={styles.logoContainer}>
            <Image
              source={require('../../assets/images/hd-logo.png')}
              style={styles.logo}
              resizeMode="contain"
            />
          </View>
          ...
          >
            Scan UPI QR to view merchant details including MCC (Merchant
            Category Code), payment information, and transaction details. Built
            with React Native and Expo.
          </Text>

          <View style={styles.developerSectionCentered}>
            <Text
              style={[styles.developerLabel, { color: theme.textSecondary }]}
            >
          ...
          <View style={styles.aboutActionButtons}>
            <TouchableOpacity
              ...
              onPress={() =>
                Linking.openURL(
                  'https://github.com/GamerJagdish/UPI-MCC-Checker',
                )
              }
            >
            ...
            <TouchableOpacity
              ...
              onPress={() =>
                Linking.openURL('https://buymeacoffee.com/gamerjagdish')
              }
            >
